...
interface TodayLargeCardProps {
  item: Weather | undefined;
}

const TodayLargeCard: React.FC<TodayLargeCardProps> = (props) => {
  return (
    <>
      ...
      <div className="weather-lg-block__additional">
        <p className="weather-lg-block__feel">
          Real Feel:
          <span>{" " + props.item!.main.feels_like.toFixed(0)}º</span>
        </p>
        ...
        <p className="weather-lg-block__pressure weather-lg-block--inline">
          Pressure: <span>{props.item!.main.pressure}MB</span>
        </p>
